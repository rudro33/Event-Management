    ...
    <section ref={ref} className="min-h-screen pt-24 pb-10 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {events.map((event) => (
          <div
            key={event.id}
            className="bg-base-100 rounded-xl shadow-lg overflow-hidden transition-shadow duration-300 hover:shadow-purple-600 hover:ring-purple-600"
